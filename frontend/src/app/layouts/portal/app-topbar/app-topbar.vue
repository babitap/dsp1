...
<script>
import AppTopbarLink from './components/app-topbar-link'
import AppTopbarLinkGroup from './components/app-topbar-link-group'
import AppTopbarLinkGroupItem from './components/app-topbar-link-group-item'
